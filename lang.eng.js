...
/****** Make into english module ******/
/************* English *************/
/* const intro = {
    "sentence": "Hello! My name is Snow and I help here at the dental clinic. Would you like to learn how to use dental floss? You can answer by speech or by pressing my screen.",
    "continue_no": "No",
    "continue_yes": "Yes"
};

const cancel = "Okay. <break time='0.5s'/> Have a nice day!"

const sentence_video = {
    "sentence": "Great. It is impossible to completely clean between your teeth with a standard toothbrush. \
